...
def call_experiment(trafic_cluster_col, trafic_baseline_col, medical_cluster_col, medical_baseline_col, is_trafic, is_large, e_obj, window_size):
    cause_column, effect_column = get_cause_effect_col()
    result_path = get_result_path()
...
if __name__ == '__main__':
    ...
    if user_input == cluster:
        ...
        call_experiment(trafic_cluster_col, trafic_baseline_col, medical_cluster_col, medical_baseline_col, is_trafic, is_large, e_obj, window_size)
    elif user_input == '':
